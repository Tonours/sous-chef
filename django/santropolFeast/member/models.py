...
class Client_scheduled_status(models.Model):
    ...
    change_state = models.CharField(max_length=5, choices=CHANGE_STATUS, default=ALONE)
    operation_status = models.CharField(max_length=3, choices=OPERATION_STATUS, default=TOBEPROCESSED)
